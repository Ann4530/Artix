...
description: "Evaluate ket qua cua skill findgap: nhan log JSON + bang ket qua he thong, tinh TP/FP/FN, Precision/Recall/F1, va dien vao test_findgap_result_artix.csv."
---
...
- `<csv_path>` = duong dan den file CSV ket qua, mac dinh `test_findgap_result_artix.csv`
